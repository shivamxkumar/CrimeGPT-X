...
VALUES
  (uuid_generate_v4(), 'AHM-24-IO-047', 'SI Rajesh Sharma', 'rajesh.sharma@gujaratpolice.gov.in', '9825100047', '$2b$12$kv2J2otMxnNQjIH7XJSCdea96V/FR1zT0NhdD1KP8MltjqcrbncU6', 'IO', 'Ahmedabad Cyber Crime Branch', 'Sub-Inspector', true, true),
  (uuid_generate_v4(), 'AHM-23-SHO-012', 'DySP Amit Patel', 'amit.patel@gujaratpolice.gov.in', '9825100012', '$2b$12$kv2J2otMxnNQjIH7XJSCdea96V/FR1zT0NhdD1KP8MltjqcrbncU6', 'SHO', 'Ahmedabad Cyber Crime Branch', 'Deputy Superintendent', true, true),
  (uuid_generate_v4(), 'LEG-24-001', 'Adv. Priya Mehta', 'priya.mehta@gujaratpolice.gov.in', '9825100001', '$2b$12$kv2J2otMxnNQjIH7XJSCdea96V/FR1zT0NhdD1KP8MltjqcrbncU6', 'LEGAL', 'Legal Cell, HQ', 'Legal Advisor', true, true),
  (uuid_generate_v4(), 'ADM-24-001', 'Admin Saurabh Shah', 'admin@gujaratpolice.gov.in', '9825100000', '$2b$12$kv2J2otMxnNQjIH7XJSCdea96V/FR1zT0NhdD1KP8MltjqcrbncU6', 'ADMIN', 'HQ Gandhinagar', 'System Administrator', true, true),
  (uuid_generate_v4(), 'AHM-24-IO-053', 'SI Anita Verma', 'anita.verma@gujaratpolice.gov.in', '9825100053', '$2b$12$kv2J2otMxnNQjIH7XJSCdea96V/FR1zT0NhdD1KP8MltjqcrbncU6', 'IO', 'Ahmedabad Cyber Crime Branch', 'Sub-Inspector', true, true)
